...
// Modified by Cristiano : setup root folder proj
val homePrj = "/mnt/extended/workspaceIntelliJ/scala/prog-scala-2nd-ed-code-examples/"

s"ls -l ${homePrj}src".!
Seq("ls", "-l", s"${homePrj}src").!!
...
countLines(s"${homePrj}scala.txt").!
findURL("http://scala-lang.org", "scala").!
countLines(s"${homePrj}scala.txt").!
